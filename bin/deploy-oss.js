...
module.exports = (api, opts) => {
  api.registerCommand('deploy-oss', {
    description: `deploy the [${opts.outputDir}] to oss[${process.env.BUCKET_NAME}].`,
    ...
    const uploadFiles = async (dir, version) => {
      const cwd = path.resolve(opts.outputDir);
